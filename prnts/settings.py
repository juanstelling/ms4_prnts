"""
Django settings for prnts project.
...
ALLOWED_HOSTS = ['prnts.herokuapp.com', 'localhost']
...
# Authentication backends by Allauth
...
# From Code Institute | Project - Boutique Ado | Allauth Setup 2
...
WSGI_APPLICATION = 'prnts.wsgi.application'
...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': 'dmv5hano3',
    'API_KEY': '618181939114476',
...
if 'USE_AWS' in os.environ:
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'prnts'
    AWS_S3_REGION_NAME = 'eu-west-3'
    AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID')
    AWS_SECRET_ACCES_KEY = os.environ.get('AWS_SECRET_ACCES_KEY')
    AWS_S3_CUSTOM_DOMAIN = f'{AWS_STORAGE_BUCKET_NAME}.s3-website.eu-west-3.amazonaws.com'
